...
local SilentAimSettings = {
    ...
    ClassName = "RussianWing, by litekod",
    ToggleKey = "RightAlt",
...
Library:SetWatermark("RUSSIANWING silent by govnokod")

local Window = Library:CreateWindow({Title = 'Silent GUI from govnokod', Center = true, AutoShow = true, TabPadding = 8, MenuFadeTime = 0.2})
local GeneralTab = Window:AddTab("Silent aim")
local MainBOX = GeneralTab:AddLeftTabbox("Main") do
    ...
    Main:AddToggle("TeamCheck", {Text = "Soon", Default = SilentAimSettings.TeamCheck}):OnChanged(function()
...
local FieldOfViewBOX = GeneralTab:AddLeftTabbox("Field Of View") do
    ...
    Main:AddToggle("Visible", {Text = "Show FOV Circle"}):AddColorPicker("Color", {Default = Color3.fromRGB(245, 245, 241)}):OnChanged(function()
    ...
    Main:AddToggle("MousePosition", {Text = "Show Silent Aim Target"}):AddColorPicker("MouseVisualizeColor", {Default = Color3.fromRGB(245, 245, 241)}):OnChanged(function()
